...
{
  public:
	  PololuQik(unsigned char resetPin);//unsigned char receivePin, unsigned char transmitPin, unsigned char resetPin);
...
{
  public:
	  PololuQik2s9v1(unsigned char resetPin) : PololuQik(resetPin) {}// unsigned char receivePin, unsigned char transmitPin, unsigned char resetPin) : PololuQik(receivePin, transmitPin, resetPin) {}
...
{
  public:
	  PololuQik2s12v10(unsigned char resetPin) : PololuQik(resetPin) {}//unsigned char receivePin, unsigned char transmitPin, unsigned char resetPin) : PololuQik(receivePin, transmitPin, resetPin) {}
